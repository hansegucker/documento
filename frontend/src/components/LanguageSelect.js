...
function LanguageSelect(props) {
    ...
    return <div>
        <Button onClick={handleClick} variant={"outlined"}>
            <img src={"/static/" + props.locale.flag} alt={"Flag of " + props.locale.id} className={classes.flag}/>
        ...
        >
            {Object.values(locales).map((locale) => (
                ...
                >
                    <img src={"/static/" + locale.flag} alt={"Flag of " + locale.id} className={classes.flag}/>
                    {locale.shortcode}
                </MenuItem>
            ))}
        </Menu>
